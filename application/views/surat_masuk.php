...
switch ($subview) {
                            ...
                            <div class="grid" style="margin-top: 3px;">
                                <div class="row cells12">
                                    ...
                                    if (count($data) <= 0 && $this->session->userdata('masuk_level') == 'KASUBAGUMUM') {
                                        ...
                                        <?php
                                    } else if (count($data) > 0 && $data[(count($data) - 1)]->disKepadaPenID == $this->session->userdata('masuk_id') && $this->session->userdata('masuk_level') != 'SEKRETARIS/PANITERA') {
                                        ?>
                                        <a class="image-button success place-left" onclick="sm_tambah_disposisi('<?php echo $data_query->surID; ?>')">Lanjut Disposisi<span class="icon mif-user-check bg-darkGreen"></span></a>&nbsp;
                                        ...
                                        ?>
                                        <a class="image-button success place-left" onclick="sm_tambah_disposisix('<?php echo $data_query->surID; ?>')">Lanjut Disposisi<span class="icon mif-user-check bg-darkGreen"></span></a>&nbsp;
                                        <a class="image-button alert" onclick="sm_tolak_disposisi('<?php echo $data[(count($data) - 1)]->disID; ?>')">Tolak Disposisi<span class="icon mif-user-minus bg-darkRed"></span></a>
                                        <?php
                                    }
                                    ?>
                                ...
                                <div class="row cells12 no-margin">
                                    <table style="margin-top: 5px;margin-bottom: 0px;">
                                        <tr>
                                            ...
                                            <td style="width:25px"></td>
                                            <td><label><?php echo (($data_query2->perJsPegID != null) ? $ci->PegawaiModel->getbyid($data_query2->perJsPegID)->pegNama : 'Belum Ditunjuk'); ?></label></td>
                                        </tr>
                                    </table>
                                </div>
                                <div class="row cells12 no-margin">
                            ...
                            <div class="grid" style="margin-top: 3px;">
                                <div class="row cells12">
                                    ...
                                    if (count($data) <= 0 && $this->session->userdata('masuk_level') == 'KASUBAGUMUM') {
                                        ...
                                        ?>
                                        <a class="image-button success place-left" onclick="sm_tambah_disposisixy('<?php echo $data_query->surID; ?>')">Lanjut Disposisi<span class="icon mif-user-check bg-darkGreen"></span></a>&nbsp;
                                        <a class="image-button alert" onclick="sm_tolak_disposisi('<?php echo $data[(count($data) - 1)]->disID; ?>')">Tolak Disposisi<span class="icon mif-user-minus bg-darkRed"></span></a>
                                        <?php
                                    }
                                    ?>    
    ...
    default:
        ?>
        <div class="row padding20">
            <h1 class="text-light fg-orange"><a href="" class="icon mif-arrow-left fg-green"><span></span></a> Kelola Surat Masuk </h1>
            <hr class="thin bg-orange">
            <?php if ($this->session->flashdata("msg_sukses") != "") { ?>
                <div class="row" id="notif">
                    <div class="padding10 bg-green fg-white text-light"><span class="mif-warning"></span> <?php echo $this->session->flashdata("msg_sukses"); ?></div>
                        ...
                        <div class="row">
                            ...
                            <div class="row" style="margin-bottom: 50px;margin-top: 10px;">
                                <table class="dataTable border bordered tabel" data-role="datatable" data-auto-width="false">
                                    ...
                                    <tbody>
                                        <?php
                                        $data_query = $ci->SuratMasukModel->getall_tabayun($this->session->userdata('masuk_id'));
                                        foreach ($data_query as $row) {
                                            ?>
                                            <tr>
                                                <?php
                        ...
                        <div class="row">
                            ...
                            <div class="row" style="margin-bottom: 50px;margin-top: 10px;">
                                <table class="dataTable border bordered tabel" data-role="datatable" data-auto-width="false">
                                    ...
                                    <tbody>
                                        <?php
                                        $data_query = $ci->SuratMasukModel->getall_penting($this->session->userdata('masuk_id'));
                                        foreach ($data_query as $row) {
                                            ?>
                                            <tr>
                                                <?php
                            ...
                            <div class="row">
                                ...
                                <div class="row" style="margin-bottom: 50px;margin-top: 10px;">
                                    <table class="dataTable border bordered tabel" data-role="datatable" data-auto-width="false">
                                        ...
                                        <tbody>
                                            <?php
                                            $data_query = $ci->SuratMasukModel->getall_rabi($this->session->userdata('masuk_id'), 'RAHASIA');
                                            foreach ($data_query as $row) {
                                                ?>
                                                <tr>
                                                    <?php
                            ...
                            <div class="row">
                                ...
                                <div class="row" style="margin-bottom: 50px;margin-top: 10px;">
                                    <table class="dataTable border bordered tabel" data-role="datatable" data-auto-width="false">
                                        ...
                                        <tbody>
                                            <?php
                                            $data_query = $ci->SuratMasukModel->getall_rabi($this->session->userdata('masuk_id'), 'BIASA');
                                            foreach ($data_query as $row) {
                                                ?>
                                                <tr>
                                                    <?php
...
<script type="text/javascript">
                                $(document).ready(function() {
                                    ...
                                    $("#formsm_tambah_disposisi").on('submit', (function(e) {
                                        ...
                                        if (disSumSukID.length > 0 && disKepadaPenID.length > 0 && disUraian.length > 0) {
                                            $.ajax({
                                                ...
                                                {
                                                    metroDialog.close('#modalsm_tambah_disposisi');
                                                    document.getElementById("pesan_modalsmd_info_gagal").innerHTML = "Terjadi Kesalahan,Data Disposisi Gagal Dikirim";
                                                    metroDialog.toggle('#modalsmd_info_gagal');
                                                }
                                            });
                                        } else {
                                            metroDialog.close('#modalsm_tambah_disposisi');
                                            document.getElementById("pesan_modalsmd_info").innerHTML = 'Maaf, Form Data Tanda (*) Tidak Boleh Kososng !';
                                            metroDialog.toggle('#modalsmd_info');
                                        }
                                    }));

                                    $("#formsm_tambah_disposisix").on('submit', (function(e) {
                                        e.preventDefault();
                                        $(".btn-smp-dis").addClass('disabled');
                                        for (disUraian2 in CKEDITOR.instances) {
                                            CKEDITOR.instances[disUraian2].updateElement();
                                        }
                                        var base_url = '<?php echo base_url(); ?>';
                                        var disSumSukID = $('input[name="disSumSukID2"]').val();
                                        var disKepadaPenID = $("select[name=disKepadaPenID2]").val();
                                        var surTglPenyelesaian = $('input[name="surTglPenyelesaian"]').val();
                                        var disUraian2 = CKEDITOR.instances.disUraian2.getData();
//                                        alert(disUraian2 + '/' + disSumSukID + '/' + disKepadaPenID);
                                        false;
                                        if (disSumSukID.length > 0 && disKepadaPenID.length > 0 && disUraian2.length > 0 && surTglPenyelesaian.length > 0) {
                                            $.ajax({
                                                url: base_url + 'disposisi/simpan_disposisi2/',
                                                type: "POST",
                                                data: new FormData($(this)[0]),
                                                dataType: "json",
                                                cache: false,
                                                ...
                                                success: function(data)
                                                {
                                                    metroDialog.close('#modalsm_tambah_disposisix');
                                                    if (data.status == true) {
                                                        document.getElementById("pesan_modalsmd_info_sukses").innerHTML = data.msg;
                                                        metroDialog.toggle('#modalsmd_info_sukses');
                                                    } else {
                                    ...
                                    $("#formsm_tambah_disposisixy").on('submit', (function(e) {
                                        e.preventDefault();
                                        $(".btn-smp-dis").addClass('disabled');
                                        for (disUraian3 in CKEDITOR.instances) {
                                            CKEDITOR.instances[disUraian3].updateElement();
                                        }
                                        var base_url = '<?php echo base_url(); ?>';
                                        var disSumSukID = $('input[name="disSumSukID3"]').val();
                                        var perKorPenID = $("select[name=perKorPenID]").val();
                                        var perJsPegID = $("select[name=perJsPegID]").val();
                                        var surTglPenyelesaian = $('input[name="surTglPenyelesaian3"]').val();
                                        var disUraian = CKEDITOR.instances.disUraian3.getData();
//                                        alert(disUraian2 + '/' + disSumSukID + '/' + disKepadaPenID);
                                        false;
                                        if (disSumSukID.length > 0 && perKorPenID.length > 0 && perJsPegID.length > 0 && disUraian.length > 0 && surTglPenyelesaian.length > 0) {
                                            $.ajax({
                                                url: base_url + 'disposisi/simpan_disposisi3/',
                                                type: "POST",
                                                data: new FormData($(this)[0]),
                                                dataType: "json",
                                                cache: false,
                                                ...
                                                success: function(data)
                                                {
                                                    metroDialog.close('#modalsm_tambah_disposisixy');
                                                    if (data.status == true) {
                                                        document.getElementById("pesan_modalsmd_info_sukses").innerHTML = data.msg;
                                                        metroDialog.toggle('#modalsmd_info_sukses');
                                                    } else {
                                ...
                                function tolak_disposisi() {
                                    $.ajax({
                                        ...
                                        success: function(data) {
                                            ...
                                            document.getElementById("pesan_modalsmd_info").innerHTML = 'Terjadi Kesalahan';
                                            metroDialog.toggle('#modalsmd_info');
                                        }
                                    });
                                }
                                var id_disposisix;
                                function sm_tambah_disposisix(id) {
                                    id_disposisix = id;
                                    metroDialog.toggle('#modal_konfirm_tambah_disposisix');
                                }
                                function tidak_tujuk_pelaksana_disposisi() {
                                    metroDialog.close('#modal_konfirm_tambah_disposisix');
                                    $('#formsm_tambah_disposisi')[0].reset();
                                    CKEDITOR.replace('disUraian', {width: 420, height: 100});
                                    metroDialog.toggle('#modalsm_tambah_disposisi');
                                }
                                function tujuk_pelaksana_disposisi() {
                                    metroDialog.close('#modal_konfirm_tambah_disposisix');
                                    $('#formsm_tambah_disposisix')[0].reset();
                                    CKEDITOR.replace('disUraian2', {width: 420, height: 100});
                                    metroDialog.toggle('#modalsm_tambah_disposisix');
                                }
                                var id_disposisixy;
                                function sm_tambah_disposisixy(id) {
                                    id_disposisixy = id;
                                    $('#formsm_tambah_disposisixy')[0].reset();
                                    CKEDITOR.replace('disUraian3', {width: 520, height: 100});
                                    metroDialog.toggle('#modalsm_tambah_disposisixy');
                                }
        ...
        <form id="formsm_tambah_disposisi" method="POST" action="" data-role="validator" data-show-required-state="true" data-show-success-state="true" data-hint-mode="line" data-hint-background="bg-red" data-hint-color="fg-white" enctype="multipart/form-data">
            <div class="grid">
                ...
                <div class="row cells12 no-margin">
                    ...
                    <div class="cell colspan6">
                        <div class="input-control success full-size">
                            <label style="font-size: 16px;"><?php echo $this->session->userdata('masuk_nama'); ?></label>
                        </div>
                    </div>
                </div>
                <div class="row cells12 no-margin">
                    ...
                    <div class="cell colspan6">
                        <div class="input-control success full-size">
                            <label style="font-size: 16px;"><?php echo $ci->Konfigurasi->MSQLDateToNormalInUnix(date('Y-m-d')) . ' / ' . date('H:i'); ?></label>
                        </div>
                    </div>
                </div>
                <div class="row cells12 no-margin">
                    ...
                    <div class="cell colspan7">
                        <div class="input-control success full-size">
                            <select class="js-select full-size" name="disKepadaPenID">
                ...
                <div class="row cells12 no-margin">
                    ...
                    <div class="cell colspan8"><div class="input-control textarea success full-size" data-role="input" data-text-auto-resize="true" data-text-max-height="100">
                            <textarea name="disUraian" id="disUraian"></textarea>
                        </div>
                    </div>
                </div>
                <div class="row"><span class="icon mif-warning mini fg-red place-left"><label class="text-italic"> Tanda <b>*</b> Harus Diisi !</label></span></div>
                <div class="row cells12">
                    ...
                    <div class="cell colspan5 place-right no-margin">
                        <button type="submit" class="button success btn-smp-dis"><span class="mif-floppy-disk"></span> Simpan</button>
...
<div data-role="dialog" id="modalsm_tambah_disposisix" class="padding20 text-bold" data-close-button="false" data-width="50%" data-show="false" data-overlay="true" data-overlay-color="op-gray" data-overlay-click-close="false" data-color="fg-green">
    <div class="row">
        <h3 class="text-light fg-orange" id="judulTSuratMasukPreStaff"><span class="icon mif-users small bg-orange fg-white cycle-button"></span> Disposisi Surat</h3>
        <hr class="bg-orange"/>
        <form id="formsm_tambah_disposisix" method="POST" action="" enctype="multipart/form-data">
            <div class="grid">
                <input name="disSumSukID2" type="hidden" value="<?php echo $data_query->surID; ?>">
                <div class="row cells12 no-margin">
                    <div class="cell colspan4 bg-green fg-white padding10"><label>Dari </label><label class="fg-red">*</label></div>
                    <div class="cell colspan6">
                        <div class="input-control success full-size">
                ...
                <div class="row cells12 no-margin">
                    ...
                    <div class="cell colspan7">
                        <div class="input-control success full-size">
                            <select class="js-select full-size" name="disKepadaPenID2">
                                <option value="">Pilih Tujuan Disposisi</option>
                                <?php
                                $data = $ci->DisposisiModel->getall_tujuan_disposisi($this->session->userdata('masuk_id'));
                                foreach ($data as $row) {
                ...
                <div class="row cells12 no-margin">
                    <div class="cell colspan4 bg-green fg-white padding10"><label>Tanggal Penyelesaian </label><label class="fg-red">*</label></div>
                    <div class="cell colspan7">
                        <div class="input-control text success full-size" data-role="datepicker">
                            <input type="text" name="surTglPenyelesaian">
                            <button class="button"><span class="mif-calendar"></span></button>
                        </div>
                    </div>
                </div>
                <div class="row cells12 no-margin">
                    ...
                    <div class="cell colspan8">
                        <div class="input-control file success full-size" data-role="input">
                            <input type="file" name="disNamaFile2">
                            <button class="button"><span class="mif-folder"></span></button>
                        </div>
                        <label class="fg-red mif-warning"> Format File (pdf, ms.word, ms.exel, rar & zip) & Size max 5Mb </label>
                    </div>
                ...
                <div class="row cells12 no-margin">
                    <div class="cell colspan4 bg-green fg-white padding10" style="height: 145px;margin-top: 5px;"><label>Uraian</label><label class="fg-red">*</label></div>
                    <div class="cell colspan8"><div class="input-control textarea success full-size" data-role="input" data-text-auto-resize="true" data-text-max-height="100">
                            <textarea name="disUraian2" id="disUraian2"></textarea>
                        </div>
                    </div>
                </div>
                <div class="row"><span class="icon mif-warning mini fg-red place-left"><label class="text-italic"> Tanda <b>*</b> Harus Diisi !</label></span></div>
...
<div data-role="dialog" id="modalsm_tambah_disposisixy" class="padding10 text-bold" data-close-button="false" data-width="60%" data-show="false" data-overlay="true" data-overlay-color="op-gray" data-overlay-click-close="false" data-color="fg-green">
    <div class="row">
        <h3 class="text-light fg-orange" id="judulTSuratMasukPreStaff"><span class="icon mif-users small bg-orange fg-white cycle-button"></span> Disposisi Surat</h3>
        <hr class="bg-orange"/>
        <form id="formsm_tambah_disposisixy" method="POST" action="" enctype="multipart/form-data">
            <div class="grid">
                <input name="disSumSukID3" type="hidden" value="<?php echo $data_query->surID; ?>">
                <div class="row cells12 no-margin">
                    <div class="cell colspan4 bg-green fg-white padding10"><label>Dari </label><label class="fg-red">*</label></div>
                    <div class="cell colspan6">
                        <div class="input-control success full-size">
                ...
                <div class="row cells12 no-margin">
                    <div class="cell colspan4 bg-green fg-white padding10"><label>Koordinator JS </label><label class="fg-red">*</label></div>
                    <div class="cell colspan7">
                        <div class="input-control success full-size">
                            <select class="js-select full-size" name="perKorPenID">
                                <option value="">Pilih Koor. Jurusita</option>
                                <?php
                                $data = $ci->DisposisiModel->getall_koorjs_disposisi();
                                foreach ($data as $row) {
                                    echo '<option value="' . $row->penID . '">' . $row->pegNip . ' | ' . $row->pegNama . '</option>';
                                }
                                ?>
                            </select>
                        </div>
                ...
                <div class="row cells12 no-margin">
                    ...
                    <div class="cell colspan7">
                        <div class="input-control success full-size">
                            <select class="js-select full-size" name="perJsPegID">
                                <option value="">Pilih Jurusita / JSP</option>
                                <?php
                                $data = $ci->DisposisiModel->getall_js_disposisi();
                                foreach ($data as $row) {
                                    echo '<option value="' . $row->pegID . '">' . $row->pegNip . ' | ' . $row->pegNama . '</option>';
                                }
                                ?>
                            </select>
                        </div>
                ...
                <div class="row cells12 no-margin">
                    ...
                    <div class="cell colspan7">
                        <div class="input-control text success full-size" data-role="datepicker">
                            <input type="text" name="surTglPenyelesaian3">
                            <button class="button"><span class="mif-calendar"></span></button>
                        </div>
                    </div>
                </div>
                <div class="row cells12 no-margin">
                    ...
                    <div class="cell colspan8">
                        <div class="input-control file success full-size" data-role="input">
                            <input type="file" name="disNamaFile3">
                            <button class="button"><span class="mif-folder"></span></button>
                        </div>
                        <label class="fg-red mif-warning"> Format File (pdf, ms.word, ms.exel, rar & zip) & Size max 5Mb </label>
                    </div>
                ...
                <div class="row cells12 no-margin">
                    <div class="cell colspan4 bg-green fg-white padding10" style="height: 145px;margin-top: 5px;"><label>Uraian</label><label class="fg-red">*</label></div>
                    <div class="cell colspan8"><div class="input-control textarea success full-size" data-role="input" data-text-auto-resize="true" data-text-max-height="100">
                            <textarea name="disUraian3" id="disUraian3"></textarea>
                        </div>
                    </div>
                </div>
                <div class="row"><span class="icon mif-warning mini fg-red place-left"><label class="text-italic"> Tanda <b>*</b> Harus Diisi !</label></span></div>
...
<div data-role="dialog" id="modal_konfirm_tambah_disposisix" class="padding20" data-close-button="true" data-type="alert" data-width="30%" data-show="false" data-overlay="true" data-overlay-color="op-gray" data-overlay-click-close="false">
    <h3 class="text-light fg-white"><span class="icon mif-question small bg-red fg-white cycle-button"></span> Konfirmasi ?</h3>
    <hr class="bg-orange"/>
    <p>
        Apakah Anda Ingin Menunjuk Pelaksana ?
    </p>
    <div class="grid">
        <div class="row cells12">
            <div class="cell colspan4"></div>
            <div class="cell colspan8 place-right">
                <button onclick="tujuk_pelaksana_disposisi()" class="button text-accent"><span class="mif-checkmark"></span> Ya</button>
                <button onclick="tidak_tujuk_pelaksana_disposisi()" class="button primary text-accent"><span class="mif-cross"></span> Tidak</button>
            </div>
        </div>
    </div> 
</div>
<div data-role="dialog" id="modalsmd_info_sukses" class="padding20" data-close-button="false" data-type="success" data-width="30%" data-show="false" data-overlay="true" data-overlay-color="op-gray" data-overlay-click-close="false">
    <h3 class="text-light fg-white"><span class="fg-white"></span> Informasi Sukses</h3>
    <hr class="bg-yellow"/>
...
<div data-role="dialog" id="modalsmd_info_gagal" class="padding20" data-close-button="false" data-type="alert" data-width="30%" data-show="false" data-overlay="true" data-overlay-color="op-gray" data-overlay-click-close="false">
    <h3 class="text-light fg-white"><span class="fg-white"></span> Informasi Gagal</h3>
    <hr class="bg-yellow"/>
    <p id="pesan_modalsmd_info_gagal" class="fg-white text-light"></p>
    <div class="grid">
        <div class="row cells12">
            <center><button onclick="reload_page()" class="button text-accent fg-red"><span class="mif-cross"></span> Tutup</button></center>
        </div>
    </div> 
</div>
<div data-role="dialog" id="modalsmd_info" class="padding20" data-close-button="false" data-type="warning" data-width="30%" data-show="false" data-overlay="true" data-overlay-color="op-gray" data-overlay-click-close="false">
    <h3 class="text-light fg-white"><span class="fg-white"></span> Informasi</h3>
    <hr class="bg-yellow"/>
    <p id="pesan_modalsmd_info" class="fg-white text-light"></p>
    <div class="grid">
        <div class="row cells12">
            <center><button onclick="reload_page()" class="button success text-accent"><span class="mif-cross"></span> Tutup</button></center>
        </div>
    </div> 
</div>